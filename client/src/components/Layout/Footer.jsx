    ...
    <div className="footer-section">
      <div className="footer-container">
        <div className="ft-info">
          <div className="ft-info-p1">
            <p className="ft-title">
              <img className="logo-image" src={logo} atl="logo"/>
            </p>
        ...
        <div className="ft-list">
          <p className="ft-list-title">Thông tin</p>
          <ul className="ft-list-items">
            <li>
              <ion-icon name="home-outline"></ion-icon>
              <span>Địa chỉ: 01 Võ Văn Ngân Thủ Đức</span>
            </li>
            <li>
              <ion-icon name="call-outline"></ion-icon>
              <span>Hotline: (012)123123</span>
            </li>
            <li>
        ...
        <div className="ft-list">
          <p className="ft-list-title">Chính sách</p>
          <ul className="ft-list-items">
            <li>
            ...
            <li>
              <Link to={"/legal"}>Điều khoản dịch vụ</Link>
            </li>
            <li>
              <Link to={"/legal"}>Tư vấn</Link>
            </li>
            <li>
              <Link to={"/legal"}>Cách thức hoạt động</Link>
            </li>
          </ul>
        </div>
      </div>
