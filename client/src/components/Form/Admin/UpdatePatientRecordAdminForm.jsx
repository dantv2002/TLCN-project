...
import { updatePatientRecordAdminApi, readPatientRecordAdminApi } from '../../../utils/api/admin'
import "../../../css/User.css"
import { useParams, useNavigate } from 'react-router-dom'
import axios from 'axios'
import moment from 'moment'

const UpdatePatientRecordAdminForm = () => {
    ...
    const handleUpdatePatientRecord = async (e) => {
      ...
      try {
        ...
        console.log(error);
        alert("Chỉnh sửa hồ sơ không thành công");
      }
    };
    return (
        <div>
...
export default UpdatePatientRecordAdminForm